...
\label{sec_logica_controle_aplicado}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{4 Formulacao matematica/Imagens diagrama/1 Geral.png}
...
\label{subsec_definicao_eixos_convecao_lvlh}
...
\label{subsec_aprox_longa_distancia}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{4 Formulacao matematica/Imagens diagrama/1 App longa.png}
...
\label{subsec_aprox_curta_distancia_hcw_pd}

A etapa de aproximação de curta distância utiliza as equações lineares de \gls{hcw} (Equações~\ref{eq_equacoes_HillX}, \ref{eq_equacoes_HillY} e \ref{eq_equacoes_HillZ}) no referencial \gls{lvlh}, ainda assumindo órbita circular com referência no alvo.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{4 Formulacao matematica/Imagens diagrama/2 App curta.png}
...
\label{subsubsec_lei_pd_translacional_por_eixo}
...
\label{subsubsec_limitacao_velocidade_relativa_curta}
...
\label{subsubsec_lei_pd_atitude_quaternion}
...
A atitude desejada é a coincidência com o \gls{lvlh} centrado no alvo.
...
Por fim, o erro de atitude é calculado por quaternion como o produto entre o quaternion desejado e o conjugado do quaternion atual, conforme \ref{eq_quat_relativo}.

%%%%%%%%%%%%%%%% APP FINAL

\subsection{Aproximação final e comutação de dinâmica}
\label{subsec_aprox_final_comutacao_dinamica}
...
Enquanto o perseguidor não permanece na região pelo tempo necessário, mantém-se o modo anterior, ou seja dinâmica do corpo rígido calculado por \ref{eq_euler_corpo_rigido}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{4 Formulacao matematica/Imagens diagrama/3 App final.png}
...
\label{subsubsec_compensacao_torque_reacao_atitude}
...
\label{subsec_subsistema_mr_cinematica_controle}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{4 Formulacao matematica/Imagens diagrama/4 MR.png}
