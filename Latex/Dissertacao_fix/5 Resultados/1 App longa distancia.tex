...
A Tabela~\ref{tab_cap4_1_raio_orbital} apresenta os raios orbitais circularizados do perseguidor no instante inicial e após a \gls{th}, em comparação com o raio orbital do alvo. As altitudes iniciais são $500$ km (perseguidor) e $600$ km (alvo).
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{5 Resultados/Imagens/1 App longa distancia/1 Transferência de órbita.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{5 Resultados/Imagens/1 App longa distancia/1 Final da transf orbita.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{5 Resultados/Imagens/1 App longa distancia/2 Longitude ao longo do tempo.png}
...
A Tabela~\ref{tab_cap4_3_longitude_instantes} apresenta as longitudes em instantes selecionados e a respectiva diferença de fase.
...
\begin{table}[H]
\centering
\caption{Diferença de fase ao longo do tempo (\gls{eci})}
\begin{tabularx}{\linewidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
\hline
\multicolumn{1}{|c|}{\textbf{Instante}} &
\multicolumn{3}{c|}{\textbf{Longitude relativa [grau]}} \\
...
\hline
\end{tabularx}
\label{tab_cap4_3_longitude_instantes}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{5 Resultados/Imagens/1 App longa distancia/3 Raio orbital ao longo do tempo.png}
...
A transferência de Hohmann requer dois impulsos. A Tabela~\ref{tab_cap4_deltav} apresenta, para cada queima, o instante de ocorrência e o correspondente consumo de $\Delta v$.
...
% \begin{figure}[H]
% \centering
% \includegraphics[width=1\linewidth]{5 Resultados/Imagens/1 App longa distancia/4 Distância relativa ao longo do tempo.png}
% \caption{Evolução da distância relativa entre as espaçonaves no referencial \gls{eci}.}
%     \label{fig:cap4_4_dist_relativa}
% \end{figure}

% Para melhor visualização, a Tabela~\ref{tab_cap4_dist_relativa_eci} apresenta as distâncias relativas em determinados instantes de tempo, os mesmos utilizados anteriormente.

% \begin{table}[H]
% \centering
% \caption{Distância relativa em \gls{eci} nos instantes principais}
% \begin{tabularx}{\linewidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
% \hline
% \multicolumn{1}{|c|}{\textbf{Instante de tempo [s]}} &
...
% \hline
% \end{tabularx}
% \label{tab_cap4_dist_relativa_eci}
% \end{table}
...
Conforme a Tabela~\ref{tab_cap4_longitude_cenarios}, o primeiro cenário (A) possui as medidas e valores já apresentados até o momento, enquanto que o cenário (B) possui nova condição inicial para nova análise.

\begin{table}[H]
\centering
\caption{Longitude relativa inicial do perseguidor por cenário}
\begin{tabularx}{\linewidth}{|>{\centering\arraybackslash}X|>{\centering\arraybackslash}X|}
\hline
\multicolumn{1}{|c|}{\textbf{Cenário}} &
\multicolumn{1}{c|}{\textbf{Longitude relativa inicial do perseguidor}} \\
\hhline{|=|=|}
...
\hline
\end{tabularx}
\label{tab_cap4_longitude_cenarios}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{4 Formulacao matematica/Imagens/Cenario A e B.png}
\caption{Posições iniciais do perseguidor em cada cenário.}
\label{fig:cap4_posicoes_cenarios}
\end{figure}

\subsubsection{Longitude relativa ao alvo no instante da queima}

Ao modificar a longitude inicial e o raio orbital inicial do perseguidor, os instantes de queima também foram alterados conforme apresentados nas Tabela~\ref{tab_cap4_longitudes_queimas} e Tabela~\ref{tab_cap4_longitudes_queimas_rad}.
...
\begin{table}[H]
\centering
\caption{Longitudes relativas na queima 1 e queima 2}
...
\hhline{|=|=|=|=|}
Longitude relativa do perseguidor na queima 1 & grau & 229,38 & 128,15 \\
\hline
Longitude do alvo na queima 1        & grau & 231,31 & 132,02 \\
\hline
Longitude relativa do perseguidor na queima 2 & grau & 49,38  & 308,15 \\
\hline
Longitude do alvo na queima 2        & grau & 49,38  & 308,16 \\
\hline
\end{tabularx}
\label{tab_cap4_longitudes_queimas}
\end{table}
...
\multicolumn{1}{c|}{\textbf{Cenário B}} \\
\hhline{|=|=|=|=|}
Longitude relativa do perseguidor na queima 1 & radiano & 4,0034   & 2,2367   \\
\hline
Longitude do alvo na queima 1        & radiano & 4,0372   & 2,3041   \\
\hline
Longitude relativa do perseguidor na queima 2 & radiano & 0,861774 & 5,378311 \\
\hline
Longitude do alvo na queima 2        & radiano & 0,861846 & 5,378383 \\
\hline
\end{tabularx}
\label{tab_cap4_longitudes_queimas_rad}
\end{table}

\subsubsection{Comparativo entre os cenários}

A Tabela~\ref{tab_cap4_comp_alt_tempos} apresenta novos valores de altitude e tempos obtidos após a mudança nos parâmetros iniciais do perseguidor durante a fase de aproximação de longa distância.
...
\hline
\end{tabularx}
\label{tab_cap4_comp_alt_tempos}
\end{table}
...
Os parâmetros obtidos estão na Tabela~\ref{tab_cap4_comp_deltav} e foram calculados através da equação \emph{vis-viva}, ver \ref{eq_vis_viva}.
...
\hline
\end{tabularx}
\label{tab_cap4_comp_deltav}
\end{table}

\subsubsection{Elementos orbitais}

Os elementos orbitais, apresentados na Tabela~\ref{tab_cap4_elementos_perseguidor}, foram coletados no final da aproximação de longa distância e não foram alterados.
...
\hline
\end{tabularx}
\label{tab_cap4_elementos_perseguidor}
\end{table}

No Apêndice~\ref{ap_ApendiceA} são apresentadas as posições e velocidades no referencial inercial.
