...
Após o lançamento do \emph{Sputnik-1} \cite{nasa1957}, no final dos anos 50, e do início de uma série de satélites com na ordem de toneladas \cite{sputnik3}, a União das Repúblicas Socialistas Soviéticas (URSS) demonstrou possuir foguetes com maior capacidade de carga que seus equivalentes no restante do globo.
