\subsubsection{Controle de atitude da base física}
\label{sec:controle_PD_atitude}

A atitude da base da espaçonave é descrita por um quaternion unitário, conforme a Equação \eqref{eq:qrel_sincronizacao}, ou seja:
...
O erro da atitude da base física é obtido através da Equação \eqref{eq:quat_relativo}, ou seja:
