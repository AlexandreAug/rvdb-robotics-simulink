...
A Figura~\ref{fig:cap4_atitude_grau} apresenta a evolução da atitude do perseguidor ao longo da aproximação, evidenciando seu alinhamento em relação à atitude da espaçonave alvo.
...
\begin{figure}[H]
\centering
\includegraphics[width=1\linewidth]{4 Resultados e discussoes/Imagens/3 App final/1A Atitude perseguidor.png}
\caption{Atitude do perseguidor em ângulos de Euler ao longo de toda a aproximação.}
\label{fig:cap4_atitude_grau}
\end{figure}
