...
\label{sec:modelos_atuadores_sensores}
...
Adotou-se a hipótese de modelos ideais, isto é, sem efeitos dissipativos ou não lineares de hardware, como atrito, variações térmicas, elasticidade estrutural, atrasos, quantização ou ruído de medição.
...
\label{subsec:hipoteses_idealizacao}
...
\label{subsubsec:atuacao_translacional}
...
\label{subsubsec:atuacao_translacional_longa}
...
\label{subsubsec:atuacao_atitude}
...
\subsubsection{Atuação do MR}
\label{subsubsec:atuacao_mr}
...
\subsection{Modelos de sensoriamento e variáveis disponíveis ao controle}
\label{subsec:modelos_sensoriamento_variaveis}
...
\label{subsubsec:sensoriamento_translacional}
...
\label{subsubsec:sensoriamento_atitude}
...
\label{subsubsec:sensoriamento_mr_cinematica}
...
A referência geométrica do efetuador é obtida a partir da posição relativa do perseguidor em \gls{lvlh}, transformada para o referencial 0, e utilizada como entrada da cinemática inversa.
...
\label{subsec:limites_operacionais_logica}
...
\label{subsec:saturacoes_limitadores_operacionais}
...
\label{subsubsec:limitacao_veloc_relativa_lvlh}
...
\label{subsubsec:saturacao_acel_pd_translacional}
...
\label{subsubsec:saturacoes_modo_acoplado_mr}
...
\label{subsubsec:motivacao_fisica_limitadores}
