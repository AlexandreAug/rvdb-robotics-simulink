...
No manipulador 3R deste trabalho, os eixos de junta são organizados no arranjo $Z$--$X$--$X$ em relação à base física: a junta~1 rotaciona em torno de um eixo vertical alinhado com $\hat{z}_{B}$, enquanto as juntas~2 e~3 rotacionam em torno de eixos paralelos a $\hat{x}_{B}$. 
