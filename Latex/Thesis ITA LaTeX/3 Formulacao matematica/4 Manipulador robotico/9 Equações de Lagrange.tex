...
\sum_{l=1}^{n_g}
\left(
\frac{\partial m_{kj}(\vec q\,)}{\partial q_l}
-
\frac{1}{2}\frac{\partial m_{lj}(\vec q\,)}{\partial q_k}
\right)\dot q_l,
\qquad
k,j = 1,\dots,n_g.
...
onde o termo $C(\vec q\,,\dot{\vec q\,})\,\dot{\vec q\,}$ agrupa as contribuições centrífugas e de Coriolis.
