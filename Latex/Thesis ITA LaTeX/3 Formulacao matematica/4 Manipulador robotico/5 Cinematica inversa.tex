...
Dados a pose desejada do efetuador (posição e orientação), o problema de cinemática inversa consiste em determinar todos os possíveis conjuntos de ângulos de junta que produzem essa pose. Na cinemática de manipuladores, essa determinação da pose do efetuador é um problema fundamental.
...
Portanto, a existência ou a inexistência de uma solução de cinemática inversa define o espaço de trabalho de um dado manipulador. A ausência de solução indica que o manipulador não consegue atingir a pose desejada, isto é, não pode alcançar simultaneamente a posição e a orientação especificadas por estarem fora do seu espaço de trabalho.
