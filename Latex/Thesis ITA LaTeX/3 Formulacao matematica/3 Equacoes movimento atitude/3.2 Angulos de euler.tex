...
$C_1(\theta_1) \leftarrow C_2(\theta_2) \leftarrow C_3(\theta_3)$ que leva o
referencial inercial $A$ até o sistema do corpo $B$. Introduzem-se dois
referenciais intermediários $A'$ e $A''$:
\begin{equation}
C_3(\theta_3): A' \leftarrow A,\qquad
C_2(\theta_2): A'' \leftarrow A',\qquad
C_1(\theta_1): B \leftarrow A'',
\end{equation}
...
$C_1(\theta_1) \leftarrow C_2(\theta_2) \leftarrow C_3(\theta_3)$:
\begin{equation}
\begin{bmatrix}
\dot{\theta}_1 \\[2pt] \dot{\theta}_2 \\[2pt] \dot{\theta}_3
\end{bmatrix}
...
A partir dos três ângulos $(\theta_1,\theta_2,\theta_3)$, a matriz de cossenos diretores correspondente é dada pela composição das três rotações elementares:

\begin{equation}
\mathbf{C}^{B/A}
=
\mathbf{C}_1(\theta_1)\,\mathbf{C}_2(\theta_2)\,\mathbf{C}_3(\theta_3),
\end{equation}
...
$\theta_2 = \pm 90^\circ$, pois $\cos\theta_2 = 0$ e a inversa
