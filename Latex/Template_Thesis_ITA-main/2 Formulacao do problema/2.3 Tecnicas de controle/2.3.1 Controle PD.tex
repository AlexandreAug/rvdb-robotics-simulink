...
No referencial LVLH, o movimento relativo linearizado é descrito pelas equações de Hill/Clohessy--Wiltshire.  
...
Na malha de atitude, a referência (espaçonave alvo) é a orientação desejada para o \emph{chaser}, a saída é a orientação estimada a partir dos sensores de orientação.
O erro de atitude é definido pela diferença entre essas duas informações, podendo ser representado por ângulos de Euler ou por quaternions. Neste trabalho foi utilizado quaternion para correção do erro entre as orientações.
...
O controlador PD é aplicado diretamente a esse erro, de modo que o termo proporcional reduz o desvio de posição e o termo derivativo fornece amortecimento à resposta, reduzindo a quantidade de oscilações.
