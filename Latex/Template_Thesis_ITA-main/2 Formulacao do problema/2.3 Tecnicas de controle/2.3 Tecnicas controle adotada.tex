...
\input{2 Formulacao do problema/2.3 Tecnicas de controle/2.3.1 Controle PD.tex}
\input{2 Formulacao do problema/2.3 Tecnicas de controle/2.3.2 Ganhos criterios ajuste.tex}
% \input{2 Formulacao do problema/2.3 Tecnicas de controle/2.3.3 Limitacoes.tex}
\input{2 Formulacao do problema/2.3 Tecnicas de controle/2.3.4 Justificativa.tex}