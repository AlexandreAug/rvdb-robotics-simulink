...
A matriz de inércia da base não é constante quando existe um manipulador acoplado, uma vez que à movimentação das juntas altera a distribuição de massa do sistema.
...
onde $\vec{M}_{\text{controle}}$ são os torques de controle aplicados à espaçonave e $\vec{M}_{\text{manip}}$ representam os torques de reação devido ao movimento das juntas do manipulador. Assim, a modelagem da dinâmica de atitude requer a consideração combinada da matriz de inércia variável, dos torques de controle e dos efeitos do manipulador robótico.
