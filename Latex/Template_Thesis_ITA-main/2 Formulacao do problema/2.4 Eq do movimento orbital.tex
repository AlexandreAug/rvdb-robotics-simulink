...
\footnote{O autor Fehse (2003) define a \emph{velocidade angular}, ou \emph{angular rate} ou até mesmo \emph{angular velocity} como $\omega$, outros autores, como Bate (1971), a definem como $\eta$} 
