...
onde $\vec q$ reúne as coordenadas generalizadas do MR, e $\mathbf M(\vec q)$ é a matriz de inércia generalizada.
...
Em microgravidade,
$V(\vec q)\equiv 0$ e,
portanto, $\vec g(\vec q\,)=\vec 0$, reduzindo \eqref{eq:EL_compacta} a:
