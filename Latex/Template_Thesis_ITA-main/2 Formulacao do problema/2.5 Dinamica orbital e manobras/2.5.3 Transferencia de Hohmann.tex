...
Assim que a transferência de Hohmann for concluída, o \emph{chaser} estará em uma órbita coplanar e ligeiramente abaixo da órbita do \emph{target}. 
A partir desse ponto, ajustes de fase são empregados para sincronizar os ângulos das duas espaçonaves. 
Uma vez nesta posição, a partir de \eqref{eq:relativo_LVLHgeral}, aplicam-se as técnicas de aproximação entre as espaçonaves e são descritas em termos do movimento relativo pelas equações de Hill/Clohessy-Wiltshire.