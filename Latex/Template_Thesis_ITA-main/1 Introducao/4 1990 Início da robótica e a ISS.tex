...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{1 Introducao/Imagens/Cygnus Northrop Grumman.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{1 Introducao/Imagens/Canadarm2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{1 Introducao/Imagens/Progress.jpg}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{1 Introducao/Imagens/ATV RVD.jpg}
