...
O modelo desenvolvido permitiu representar o movimento relativo nos referenciais ECI e \gls{lvlh}, bem como a dinâmica da espaçonave perseguidora tanto na condição de corpo rígido, durante a fase não-operacional, como na condição acoplada ao \gls{mr}, por meio de formulação lagrangiana baseada na energia cinética do conjunto.
