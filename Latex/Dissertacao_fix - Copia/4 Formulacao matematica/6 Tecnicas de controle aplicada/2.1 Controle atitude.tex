...
A ação de controle $\vec\tau_B$ é inserida no vetor de torques generalizados $\vec\tau$ das equações de movimento presentes na Seção~\ref{sec_atitude_inercial}, especificamente nas Equações~\eqref{eq_euler_corpo_rigido} e~\eqref{eq_dinamica_geral}, já que as primeiras coordenadas generalizadas estão associadas à atitude da espaçonave.
