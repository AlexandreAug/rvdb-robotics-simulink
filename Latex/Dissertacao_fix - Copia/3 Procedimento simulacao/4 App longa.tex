...
A partir desses parâmetros, realiza-se a conversão para o referencial inercial ECI, obtendo-se os vetores de posição e velocidade de ambas as espaçonaves.

Com os vetores de estado (posição e velocidades no ECI) definidos, procede-se à propagação orbital das trajetórias do perseguidor e do alvo. 
