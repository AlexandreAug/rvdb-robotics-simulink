...
% Esta seção estabelece o escopo da simulação da missão de \gls{rvdb} deste trabalho. 
% A sequência das etapas segue a decomposição de fases apresentada por \cite{fehse2003}, adotada como referência para estruturar o processo de aproximação entre a espaçonave perseguidora e a espaçonave alvo.

Conforme ilustrado na Figura~\ref{fig_etapas_rvdb}, presente no Capítulo~\ref{sec_Introducao_Dissertacao_orientador} deste trabalho, uma missão de \gls{rvdb} pode ser descrita como uma sequência de etapas que conduzem a espaçonave perseguidora desde a inserção orbital até a aproximação final em relação ao alvo. 
