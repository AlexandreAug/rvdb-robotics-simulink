...
O uso de algoritmos de desvio e planejamento de trajetória dinâmica é um elemento importante para garantir a segurança das missões de \gls{rvdb}, especialmente em ambientes complexos e dinâmicos, como as órbitas terrestres, operações entre espaçonaves ou próximas a corpos celestes.
