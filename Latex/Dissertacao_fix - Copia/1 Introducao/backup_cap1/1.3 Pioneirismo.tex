...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{1 Introducao/Imagens/2 Pioneirismo - ATV.jpeg}
\caption[ATV (Automated Transfer Vehicle).]{ATV (Automated Transfer Vehicle). Fonte: \gls{dlr}.}
\label{fig_pioneirismo_ATV}
\end{figure}
...
% \begin{figure}[ht]
%     \label{fig_aproximacao_rbar_pioneirismo}
% \centering
...
% \begin{figure}[ht]
%     \label{fig_aproximacao_vbar_pioneirismo}
% \centering
...
\input{1 Introducao/1.3.1 Apollo.tex}
